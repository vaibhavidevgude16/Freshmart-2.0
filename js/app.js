  ...
  const benefitCards = [
    {
      ...
      text: "Handpicked everyday essentials for your home.",
    },
    {
      title: "Affordable Prices",
      text: "Clear value on groceries without hidden surprises.",
    },
    {
      title: "Fast Delivery",
      text: "Delivery options are simple, local and easy to choose.",
    },
    {
      title: "Easy Ordering",
      text: "Browse, add to cart and checkout without confusion.",
    },
    {
      title: "Low Stock Warning",
      text: "Admins can quickly spot products that are running low.",
    },
    {
      title: "Cancel Order Option",
      text: "Customers can cancel orders before they are packed.",
    },
    {
      title: "Invoice Download",
      text: "Customers can download a simple bill after ordering.",
    },
    {
      title: "Delivery Time Slot",
      text: "Choose a delivery timing like morning, afternoon or evening.",
    },
  ]
    .map(
      (benefit) => `
